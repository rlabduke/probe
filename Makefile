# This Makefile for Probe was adopted from the generic gcc makefile.
...
MACHINEFLAGS = 
CFLAGS = -isysroot /Developer/SDKs/MacOSX10.4u.sdk -arch i386 -arch ppc $(MACHINEFLAGS)
LFLAGS = -lm -Wl,-syslibroot,/Developer/SDKs/MacOSX10.4u.sdk -arch i386 -arch ppc $(MACHINEFLAGS)
